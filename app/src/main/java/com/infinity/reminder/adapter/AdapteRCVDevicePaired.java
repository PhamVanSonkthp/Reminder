...
import com.infinity.reminder.presenter.PresenterAdapterRCVDevicePaired;
import com.infinity.reminder.views.ViewAdapterRCVDevicePairedListener;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (getItemViewType(position) == VIEW_TYPE_ITEM) {
            ...
            if (arrItem.get(position).getStatusConnect() == -1) {
                ...
                viewHodler.txtToggle.setText("Sẵn sàng kết nối");
                ...
                viewHodler.txtToggle.setText("Đã kết");
                ...
                viewHodler.txtToggle.setText("Tắt");
